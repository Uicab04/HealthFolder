      ...
      <section id="hero" class="d-flex align-items-center justify-content-center">
        <div class="container">
            ...
            <div class="card-body p-5">
                ...
                <div class="row">
                <aside> <a href="pdf/receta.php?idUsuario2=<?php echo $_SESSION['usuario_id']; ?>" target="_blank" class="scrollto btn btn-warning btn btn-primary">DescargarPDF</a></aside>
                    ...
                    <div class="col-lg-7">
                        <div class="p-2">
                            ...
                            <form class="user" name="recetaElectronica">

                              <div class="form-group">
                                <label for="paciente">Nombre del Paciente:</label>
                                <input type="text" class="form-control form-control-user" id="paciente" name="paciente" placeholder="Nombre del Paciente">
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" id="medicamento" name="medicamento" placeholder="Medicamento">
                              </div>
                            
                              <div class="form-group">
                                <label for="dosis">Dosis:</label>
                                <input type="text" class="form-control form-control-user" id="dosis" name="dosis" placeholder="Dosis">
                              </div>
                            
                              <div class="form-group">
                                <label for="frecuencia">Frecuencia:</label>
                                <input type="text" class="form-control form-control-user" id="frecuencia" name="frecuencia" placeholder="Frecuencia">
                              </div>
                            
                              <div class="form-group">
                                <label for="observaciones">Observaciones:</label>
                                <textarea class="form-control form-control-user" id="observaciones" name="observaciones" placeholder="Observaciones"></textarea>
                              </div>
                              <input type="hidden" id="idUsuario2" name="idUsuario2" value="<?php echo $_SESSION['usuario_id']; ?>">
                            
                              <div class="form-group">
                                <input type="button" value="Generar receta" onclick="validarRecetaElectronica()" class="btn btn-primary btn-user btn-block">
                              </div>
