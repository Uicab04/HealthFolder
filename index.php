      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Secciones</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="historial_medico.html">Expediente</a></li>
              ...
              <li><a href="receta.html">Receta electrónica</a></li>
      ...
      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="historial_medico.html">Expediente</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-bar-chart-box-line"></i>
            <h3><a href="citas.html">agendar cita</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-calendar-todo-line"></i>
            <h3><a href="receta.html">Receta electrónica</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-paint-brush-line"></i>
            <h3><a href="historiaClinica.html">Historia clínica</a></h3>
          </div>
        </div>
        <!-- <div class="col-xl-2 col-md-4">
          <div class="icon-box">
